...
async function loadTargetInfo() {
    ...
    try {
        ...
        const next = data.nextMilestone || 100000;
        const prev = Math.floor(target / 100000) * 100000;
