...
// ⭐ NEW: Load pending notifications from DB on login
...
async function login() {
    ...
    if (data.success) {
        ...
        // ⭐ Load pending notifications from DB
...
// ⭐ Resolve: DELETES the ticket + notifies user (online + offline)
