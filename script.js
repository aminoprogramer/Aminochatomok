// script.js
// ⭐⭐⭐ Mokalmat Chat — SECURE CLIENT v2.0 ⭐⭐⭐

// ============================================================
// ⭐ GLOBAL VARIABLES
// ============================================================
let socket, currentUser = null, currentRoom = null, currentPrivateChat = null;
let onlineUsers = [], allRooms = [];
let mediaRecorder, audioChunks = [], isRecording = false, recTarget = null;
let currentImageTarget = null;
let currentRoomOwner = null, currentRoomIsVip = false;
let youtubePlayerVisible = false;
let currentRoomModerators = [], currentRoomMembersOnly = false;
let peerConnection = null, localStream = null, callActive = false;
let pendingCallFrom = null, pendingOffer = null;
let notifications = [];
...
// ⭐ authHeaders — يضيف التوكن لكل طلب
...
// ⭐ safeFetch — يعالج انتهاء الجلسة (401)
...
// ⭐ createThrottle — منع double-click من العميل
...
const throttleSend = createThrottle(500);
const throttleGift = createThrottle(2000);
const throttleBoost = createThrottle(5000);
const throttleGame = createThrottle(1000);
const throttleCall = createThrottle(10000);
const throttleLogin = createThrottle(2000);
const throttleRegister = createThrottle(2000);
const throttleFriendReq = createThrottle(3000);

// ⭐ withButtonLock — تعطيل الزر أثناء الطلب
...
let turnCacheTime = 0;
const TURN_CACHE_TTL = 60 * 60 * 1000;
...
async function getTurnCredentials() {
    ...
    try {
        const response = await safeFetch('/api/turn-credentials', {
            headers: authHeaders()
        });
...
const translations = {
    en: {
        ...
        search_room: "Search room...", search_rooms: "Search rooms...",
        search_users: "Search users...", search: "Search",
        ...
        boosted: "boosted", total_boost: "Total boost", coins: "coins",
        new_message: "New Message", sent_gift: "sent you", gift_received: "Gift Received",
        friend_request: "Friend Request", from: "from", admin_gave: "Admin gave you",
        removed_you: "removed you from friends", kicked_from: "You were kicked from",
        incoming_call: "Incoming Call", is_calling: "is calling", call_rejected: "Call rejected",
        support_reply: "Support Reply", replied_ticket: "replied to ticket",
        new_reply_support: "New reply from support for ticket", ticket_resolved: "Ticket Resolved",
        your_ticket: "Your ticket", resolved: "has been resolved",
        new_support_ticket: "New Support Ticket", call_ended: "Call ended by other user",
        room_video_changed: "Room video changed by", someone: "someone",
        ...
        logout: "Logout", menu: "Menu", vip_status: "VIP Status",
        buy_vip: "Buy VIP Plan (20000 coins for 30 days)",
        buy_coins: "Buy Coins", card: "Card", crypto: "Crypto",
        request_coins: "Request Coins (Manual)", members_panel: "Members Panel",
        ban_kick: "Ban / Kick User", banned_list: "Banned Users List",
        ...
        basic_boost: "1500 Coins - Basic", silver_boost: "6000 Coins - Silver",
        gold_boost: "54000 Coins - Gold",
        create_room_title: "Create Room (9000 coins)",
        ...
        send_usdt: "Send USDT (TRC20) to:", transaction_id: "Transaction ID",
        submit: "Submit", send_image: "Send Image", coin_history: "Coin History",
        reply_to_ticket: "Reply to Ticket", user_message: "User message:",
        your_reply: "Your reply...", send_reply: "Send Reply", ticket_id: "Ticket ID:",
        admin_reply: "Admin Reply:", close: "Close", ticket_reply: "Ticket Reply",
        describe_issue: "Describe your issue...", subject: "Subject",
        notifications: "Notifications", kick: "Kick", unban: "Unban",
        ...
        select_gender: "Select Gender", search_users_placeholder: "Search users...",
        your_friends: "Your Friends", target: "Target",
        days_until_reset: "days until month reset",
        payout_history_title: "Payout History", gift_history_title: "Gift History",
        lucky_games_title: "Lucky Games", spin: "SPIN", spin_wheel: "SPIN WHEEL",
        select_user: "Select user...", amount_label: "Amount:", to_user: "To user:",
        message_optional: "Message (optional)", send_gift_btn: "Send Gift",
        members_count: "0 members", target_label: "Target", earned: "Earned",
        ...
        heads: "Heads", tails: "Tails", min_label: "Min", max_label: "Max",
        welcome: "Welcome", admin_payouts: "Payouts", game_logs: "Game Logs",
        mark_paid: "Mark Paid", no_games: "No games played yet",
        reply_btn: "Reply", resolve_btn: "Resolve", view_screenshot: "View Screenshot",
        subject_label: "Subject:", message_label: "Message:", from_label: "From:",
        ticket_label: "Ticket:", loading_tickets: "Loading tickets...",
        no_tickets: "No support tickets.", fill_required: "All fields required",
        request_submitted: "Request submitted! Admin will review.",
        amount_min_100: "Amount min 100", login_failed: "Login failed",
        registered_ok: "Registered! Please login.",
        password_reset_ok: "Password reset! You can now login.",
        incorrect_answer: "Incorrect security answer", vip_activated: "VIP activated!",
        user_exists: "Username exists", invalid_credentials: "Invalid credentials",
        not_enough_coins: "Not enough coins",
        need_20000_vip: "Need 20000 coins for VIP",
        need_9000_room: "Need 9000 coins to create room",
        room_exists: "Room exists", invalid_boost: "Invalid boost amount",
        ...
        upload_failed: "Upload failed", online_status: "Online", offline_status: "Offline",
        loading: "Loading...", not_active: "Not active", active_until: "Active until",
        member_since: "Member since", answer: "Answer", decline: "Decline",
        ...
        heads_btn: "Heads", tails_btn: "Tails", spin_btn: "SPIN",
        spin_wheel_btn: "SPIN WHEEL", days: "days", total: "Total",
        no_requests: "No requests", no_users_found: "No users found",
        checking: "Checking...", resetting: "Resetting...", enter_username: "Enter username",
        select_amount: "Select amount", join_room_first: "Join a room first",
        network_error: "Network error", sending: "Sending...",
        ticket_submitted: "Ticket submitted!", network_error_msg: "Network error.",
        no_notifications: "No notifications",
        creating_invoice: "Creating crypto invoice...",
        popup_blocked: "Please allow pop-ups to complete payment",
        payment_confirmed: "Payment confirmed", payment_cancelled: "Payment cancelled",
        payment_error: "Payment error", verifying_payment: "Verifying payment...",
        delete_friend_confirm: "Remove", select_user_alert: "Select a user",
        select_amount_alert: "Select an amount",
        not_enough_coins_alert: "Not enough coins",
        active_rooms: "Active Rooms", no_active_rooms: "No active rooms right now",
        no_coin_history: "No coin history yet.", loading_history: "Loading...",
        ...
        copy_code: "Copy", admin_code_lookup: "Lookup User Code (Admin)",
        lookup_code: "Lookup Code", code_copied: "📋 Code copied!",
        code_not_ready: "Code not ready yet", copy_failed: "Copy failed",
        access_denied: "Access denied", user_not_found: "User not found",
        ...
        rate_limited: "⏳ Slow down! Wait a moment.",
        too_fast: "⏳ Sending too fast",
        suspicious: "⚠️ Your account has been flagged for suspicious activity"
    },
    ar: {
        app_name: "موكلمات شات", rooms: "الغرف", friends: "الأصدقاء", gifts: "الهدايا",
        login: "تسجيل الدخول", register: "التسجيل", username: "اسم المستخدم",
        password: "كلمة المرور", send: "إرسال", join: "انضمام", create_room: "إنشاء غرفة",
        room_name: "اسم الغرفة", vip_room: "غرفة VIP", cancel: "إلغاء", create: "إنشاء",
        search_room: "ابحث عن غرفة...", search_rooms: "ابحث عن غرف...",
        search_users: "ابحث عن مستخدمين...", search: "بحث",
        ...
        boost: "تعزيز", online: "متصل", offline: "غير متصل",
        room_settings: "إعدادات الغرفة", ban_user: "طرد مستخدم",
        banned_list: "قائمة المطرودين", upload_image: "رفع صورة", upload: "رفع",
        message: "رسالة", joined: "انضم", left: "غادر", boosted: "عزز بمبلغ",
        total_boost: "إجمالي التعزيز", coins: "عملة", new_message: "رسالة جديدة",
        sent_gift: "أرسل إليك", gift_received: "هدية مستلمة",
        friend_request: "طلب صداقة", from: "من", admin_gave: "المدير أعطاك",
        removed_you: "أزالك من الأصدقاء", kicked_from: "تم طردك من",
        incoming_call: "مكالمة واردة", is_calling: "يتصل بك",
        call_rejected: "تم رفض المكالمة", support_reply: "رد الدعم",
        replied_ticket: "رد على التذكرة",
        new_reply_support: "رد جديد من الدعم للتذكرة",
        ticket_resolved: "تم حل التذكرة", your_ticket: "تذكرتك",
        resolved: "تم حلها", new_support_ticket: "تذكرة دعم جديدة",
        ...
        clear_coin_history: "مسح سجل العملات", boost_logs: "سجل التعزيزات",
        pending_requests: "الطلبات المعلقة", support_tickets: "تذاكر الدعم",
        give_coins: "منح عملات", send_coins: "إرسال عملات",
        reset_password_admin: "إعادة تعيين كلمة المرور",
        logout: "تسجيل الخروج", menu: "القائمة", vip_status: "حالة VIP",
        buy_vip: "شراء باقة VIP (20000 عملة لمدة 30 يوم)",
        ...
        basic_boost: "1500 عملة - أساسي", silver_boost: "6000 عملة - فضي",
        gold_boost: "54000 عملة - ذهبي",
        create_room_title: "إنشاء غرفة (9000 عملة)",
        ...
        add_friend: "إضافة صديق", accept: "قبول",
        no_friends: "لا يوجد أصدقاء بعد. ابحث وأضف!",
        approve: "موافقة", reject: "رفض", delete: "حذف",
        remove_mod: "إزالة مشرف", make_mod: "تعيين مشرف", reply: "رد",
        resolve: "حل", call: "اتصال", payout_history: "سجل المدفوعات",
        ...
        select_gender: "اختر الجنس", search_users_placeholder: "ابحث عن مستخدمين...",
        your_friends: "أصدقاؤك", target: "الهدف",
        days_until_reset: "يوم حتى إعادة تعيين الشهر",
        payout_history_title: "سجل المدفوعات", gift_history_title: "سجل الهدايا",
        lucky_games_title: "ألعاب الحظ", spin: "لف", spin_wheel: "لف العجلة",
        ...
        heads: "صورة", tails: "كتابة", min_label: "الحد الأدنى",
        max_label: "الحد الأقصى", welcome: "أهلاً",
        admin_payouts: "المدفوعات", game_logs: "سجل الألعاب",
        mark_paid: "تحديد كمدفوع", no_games: "لم يتم لعب أي ألعاب بعد",
        reply_btn: "رد", resolve_btn: "حل", view_screenshot: "عرض لقطة الشاشة",
        subject_label: "الموضوع:", message_label: "الرسالة:", from_label: "من:",
        ticket_label: "التذكرة:", loading_tickets: "جاري تحميل التذاكر...",
        no_tickets: "لا توجد تذاكر دعم.", fill_required: "جميع الحقول مطلوبة",
        request_submitted: "تم تقديم الطلب! سيراجعه المدير.",
        amount_min_100: "الحد الأدنى للمبلغ 100", login_failed: "فشل تسجيل الدخول",
        registered_ok: "تم التسجيل! يرجى تسجيل الدخول.",
        password_reset_ok: "تم إعادة تعيين كلمة المرور! يمكنك تسجيل الدخول الآن.",
        incorrect_answer: "إجابة سؤال الأمان غير صحيحة", vip_activated: "تم تفعيل VIP!",
        ...
        room_exists: "الغرفة موجودة بالفعل", invalid_boost: "مبلغ تعزيز غير صالح",
        ...
        upload_failed: "فشل الرفع", online_status: "متصل",
        offline_status: "غير متصل", loading: "جاري التحميل...",
        not_active: "غير نشط", active_until: "نشط حتى",
        member_since: "عضو منذ", answer: "رد", decline: "رفض",
        create_room_btn: "إنشاء غرفة (9000 عملة)",
        youtube_placeholder: "ابحث في يوتيوب أو الصق الرابط...",
        amount: "المبلغ", add: "إضافة",
        coinflip_tab: "صورة أو كتابة", dice_tab: "نرد",
        slot_tab: "ماكينة الحظ", wheel_tab: "عجلة الحظ",
        heads_btn: "صورة", tails_btn: "كتابة", spin_btn: "لف",
        spin_wheel_btn: "لف العجلة", days: "أيام", total: "المجموع",
        no_requests: "لا توجد طلبات", no_users_found: "لم يتم العثور على مستخدمين",
        checking: "جاري التحقق...", resetting: "جاري إعادة التعيين...",
        enter_username: "أدخل اسم المستخدم", select_amount: "اختر مبلغ",
        join_room_first: "انضم إلى غرفة أولاً", network_error: "خطأ في الشبكة",
        sending: "جاري الإرسال...", ticket_submitted: "تم تقديم التذكرة!",
        network_error_msg: "خطأ في الشبكة.", no_notifications: "لا توجد إشعارات",
        creating_invoice: "جاري إنشاء فاتورة العملة الرقمية...",
        popup_blocked: "يرجى السماح بالنوافذ المنبثقة لإتمام الدفع",
        payment_confirmed: "تم تأكيد الدفع",
        payment_cancelled: "تم إلغاء الدفع", payment_error: "خطأ في الدفع",
        verifying_payment: "جاري التحقق من الدفع...",
        delete_friend_confirm: "إزالة", select_user_alert: "اختر مستخدم",
        ...
        copy_code: "نسخ", admin_code_lookup: "بحث عن رمز مستخدم (مدير)",
        lookup_code: "بحث عن الرمز", code_copied: "📋 تم نسخ الرمز!",
        code_not_ready: "الرمز غير جاهز بعد", copy_failed: "فشل النسخ",
        access_denied: "الوصول مرفوض", user_not_found: "المستخدم غير موجود",
        ...
        session_expired: "⚠️ انتهت الجلسة. يرجى تسجيل الدخول مجدداً.",
        rate_limited: "⏳ تمهّل! انتظر لحظة.",
        too_fast: "⏳ ترسل بسرعة كبيرة",
        suspicious: "⚠️ تم وضع علامة على حسابك لنشاط مشبوه"
    }
};
...
function applyLanguage() {
    ...
    for (let i = 0; i < elements.length; i++) {
        ...
        if (el.tagName === 'INPUT' || el.tagName === 'TEXTAREA') {
            if (el === activeEl && el.value) continue;
            ...
            el.textContent = htmlEmoji
                ? (htmlEmoji + ' ' + cleanTranslation)
                : translation;
        } else {
            const original = el.innerText || '';
            const htmlEmoji = getLeadingEmoji(original);
            const cleanTranslation = stripLeadingEmoji(translation);
            el.innerText = htmlEmoji
                ? (htmlEmoji + ' ' + cleanTranslation)
...
function updateDynamicContent() {
    ...
    if (vipDisplay) {
        ...
        if (currentText.includes('Active until') || currentText.includes('نشط حتى')) {
            ...
            if (dateMatch) {
                vipDisplay.innerText = `💎 ${t('vip_status')}: ${t('active_until')} ${dateMatch[1]}`;
            }
...
async function loadPendingNotifications() {
    ...
    try {
        ...
        if (!data.success || !Array.isArray(data.notifications) ||
            !data.notifications.length) return;
...
function handleNotificationClick(idx) {
    ...
    if (!n) return;
    if (n?.onClickData?.type === 'private_message' &&
        currentPrivateChat !== n.onClickData.from) {
        showPrivateChat(n.onClickData.from);
...
function updateVipBadge() {
    ...
    if (badge) {
        badge.style.display = (currentUser && currentUser.isVIP === true)
            ? 'inline-block'
            : 'none';
    }
}
...
function saveSessionState() {
    ...
    if (currentPrivateChat) localStorage.setItem('lastPrivateChat', currentPrivateChat);
    else localStorage.removeItem('lastPrivateChat');
...
async function restoreSession() {
    ...
    if (lastRoom && socket && socket.connected) {
        setTimeout(() => socket.emit('join-room', lastRoom), 500);
    } else if (lastPrivate && socket && socket.connected) {
        showPrivateChat(lastPrivate);
    }
}
...
async function refreshUserData(force = false) {
    ...
    try {
        const res = await safeFetch(
            `/api/user-profile?username=${encodeURIComponent(currentUser.username)}`,
            { headers: authHeaders() }
        );
        const data = await res.json();
        if (data.success) {
...
async function checkAndUpdateVIPStatus() {
    ...
    try {
        const res = await safeFetch('/api/get-vip-status', {
            headers: authHeaders()
        });
        const data = await res.json();
...
function canCreateVipRoom() {
    return currentUser && currentUser.isVIP === true;
}
...
async function login() {
    if (!throttleLogin('login')) {
        showToast(t('too_fast'));
        return;
    }
    ...
    if (!username || !password) {
        return alert(t('fill_required') || 'Fill all fields');
    }
    ...
    try {
        ...
        if (res.status === 429) {
            return alert(data.error || 'Too many attempts. Wait a moment.');
        }
...
async function register() {
    ...
    try {
        ...
        if (res.status === 429) {
            return alert(data.error || 'Too many registrations. Try later.');
        }
...
async function getSecurityQuestion() {
    ...
    try {
        ...
        if (res.status === 429) {
            statusDiv.innerHTML = '❌ Too many attempts';
            return;
        }
...
async function resetPassword() {
    ...
    if (!username || !answer || !newPassword) {
        return alert(t('fill_required') || 'Please fill all fields.');
    }
...
async function uploadProfilePic() {
    ...
    input.onchange = async (e) => {
        ...
        reader.onload = async (ev) => {
            ...
            try {
                const res = await safeFetch('/api/upload-profile-pic-base64', {
                    method: 'POST',
                    headers: authHeaders(),
...
async function loadPrivateCode() {
    ...
    try {
        const res = await safeFetch(
            `/api/get-private-code?username=${encodeURIComponent(currentUser.username)}`,
            { headers: authHeaders() }
        );
        const data = await res.json();
        ...
        console.error('loadPrivateCode error:', e);
    }
}
...
async function adminLookupPrivateCode() {
    ...
    try {
        const res = await safeFetch(
            `/api/get-private-code?username=${encodeURIComponent(username)}`,
            { headers: authHeaders() }
        );
        const data = await res.json();
...
function displayRooms(rooms) {
    ...
    if (!rooms.length) {
        ...
        sorted.forEach((room, i) => {
            ...
            const membersOnlyTag = room.membersOnly
                ? ` <span class="members-only-badge">🔒 ${t('members_only')}</span>`
                : '';
...
function handleChatKeyDown(event, target) {
    if (event.isComposing || event.keyCode === 229) return;
    if (event.key === 'Enter' && !event.shiftKey) {
        event.preventDefault();
        if (target === 'room') sendRoomMessage();
        else if (target === 'private') sendPrivateMessage();
    }
}
...
async function translateAndDisplayMessage(msg, containerId, isSentByMe) {
    ...
    if (msg.type !== 'image' && msg.type !== 'audio' &&
        autoTranslateMessages && targetLanguage !== 'en') {
...
async function startRecording(target) {
    ...
    try {
        ...
        mediaRecorder.onstop = async () => {
            ...
            const res = await safeFetch('/api/upload-voice', {
                method: 'POST',
                headers: {
            ...
            if (data.url) {
                ...
                } else if (target === 'private' && currentPrivateChat) {
                    socket.emit('private-message', {
                        to: currentPrivateChat,
                        message: data.url,
                        type: 'audio'
        ...
        isRecording = true;
        recTarget = target;
        const btn = target === 'room'
            ? document.getElementById('roomVoiceBtn')
            : document.getElementById('privateVoiceBtn');
        if (btn) btn.classList.add('recording');
    } catch (e) {
        alert(t('microphone_needed') || 'Microphone access needed');
    }
}
...
// ⭐ IMAGE SHARING
// ============================================================
function sendRoomImage() {
    currentImageTarget = 'room';
    document.getElementById('imageModal').classList.add('active');
}
function sendPrivateImage() {
    currentImageTarget = 'private';
    document.getElementById('imageModal').classList.add('active');
}
...
async function uploadImage() {
    ...
    try {
        const res = await safeFetch('/api/upload-room-image', {
            method: 'POST',
            headers: {
                'Authorization': `Bearer ${localStorage.getItem('chat_token')}`
            },
        ...
        const data = await res.json();
        if (data.success) {
            if (currentImageTarget === 'room' && currentRoom) {
                socket.emit('room-message', {
                    message: data.imageUrl,
                    room: currentRoom,
                    type: 'image'
                });
            } else if (currentImageTarget === 'private' && currentPrivateChat) {
                socket.emit('private-message', {
                    to: currentPrivateChat,
                    message: data.imageUrl,
                    type: 'image'
...
async function loadGiftHistory() {
    try {
        const res = await safeFetch('/api/get-gifts', { headers: authHeaders() });
        const gifts = await res.json();
        const myGifts = gifts.filter(g =>
            g.to === currentUser.username || g.from === currentUser.username
        );
        const container = document.getElementById('giftHistoryList');
        if (!myGifts.length) {
            container.innerHTML = `<div>${t('no_gifts')}</div>`;
        } else {
            container.innerHTML = myGifts.map(g =>
                `<div class="gift-history-item">🎁 ${escapeHtml(g.from)} → ${escapeHtml(g.to)}: ${g.amount} ${t('coins')}<br>💬 ${escapeHtml(g.message || '')}<br><small>${new Date(g.timestamp).toLocaleString()}</small></div>`
            ).join('');
        }
    } catch (err) {
        console.error('loadGiftHistory error:', err);
    }
}
...
async function loadTargetInfo() {
    if (!currentUser) return;
    try {
        const res = await safeFetch('/api/get-target-info', { headers: authHeaders() });
        const data = await res.json();
        ...
        console.error('Target info error', e);
    }
}
...
async function loadPayoutHistory() {
    if (!currentUser) return;
    try {
        const res = await safeFetch('/api/get-payouts', { headers: authHeaders() });
        ...
        if (!payouts.length) {
            ...
            cont.innerHTML = payouts.map(p => `
                <div class="payout-item">
                    <strong>${escapeHtml(p.month)}</strong> · ${p.targetAmount.toLocaleString()} ${t('target_label')} →
...
async function showRoomGiftModal() {
    if (!currentRoom) {
        showToast(t('join_room_first') || 'Join a room first');
        return;
    }
    ...
    try {
        const res = await safeFetch(
            `/api/get-room-members/${encodeURIComponent(currentRoom)}`,
            { headers: authHeaders() }
        );
        const data = await res.json();
...
async function sendRoomGift() {
    ...
    try {
        const res = await safeFetch('/api/send-gift', {
            method: 'POST',
            headers: authHeaders(),
...
async function showAdminPayouts() {
    try {
        const res = await safeFetch('/api/get-payouts?admin=true', {
            headers: authHeaders()
        });
        const payouts = await res.json();
        const html = payouts.length ? payouts.map(p => `
            <div class="payout-item">
                <strong>${escapeHtml(p.username)}</strong> · ${escapeHtml(p.month)} · ${p.targetAmount.toLocaleString()} → 
                <b>$${p.dollarsEarned}</b>
                <span class="payout-status ${p.status}">${p.status}</span>
...
async function markPayoutPaid(id) {
    await safeFetch('/api/mark-payout-paid', {
        method: 'POST',
        headers: authHeaders(),
...
async function loadFriends() {
    try {
        const res = await safeFetch('/api/get-friends', { headers: authHeaders() });
        const friends = await res.json();
        const container = document.getElementById('friendsList');
        if (!friends.length) {
            container.innerHTML = `<div>${t('no_friends')}</div>`;
        } else {
...
async function loadFriendRequests() {
    try {
        const res = await safeFetch('/api/get-friend-requests', { headers: authHeaders() });
        const requests = await res.json();
        const container = document.getElementById('friendRequestsList');
        if (!requests.length) {
            container.innerHTML = `<div>${t('no_requests')}</div>`;
        } else {
            container.innerHTML = requests.map(req =>
                `<div class="friend-request-item">${escapeHtml(req.from)} <button onclick="acceptFriendRequest('${escapeHtml(req.from)}')">${t('accept')}</button></div>`
            ).join('');
        }
    } catch (err) {
...
async function acceptFriendRequest(from) {
    socket.emit('accept-friend-request-socket', { from });
}

async function deleteFriend(friend) {
    if (!confirm(`${t('delete_friend_confirm') || 'Remove'} ${friend}?`)) return;
    try {
        const res = await safeFetch('/api/delete-friend', {
            method: 'POST',
            headers: authHeaders(),
...
async function sendFriendRequest(to) {
    if (!throttleFriendReq(`friend_req_${to}`)) {
        showToast(t('too_fast'));
        return;
    }
    socket.emit('send-friend-request-socket', { to });
}
...
async function searchUsers() {
    ...
    if (!q) return;
    try {
        const res = await safeFetch('/api/get-all-users', { headers: authHeaders() });
        ...
        if (!filtered.length) {
            container.innerHTML = `<div>${t('no_users_found')}</div>`;
        } else {
            container.innerHTML = filtered.map(u =>
                `<div class="search-result-item">${escapeHtml(u.username)} <button class="send-req-btn" onclick="sendFriendRequest('${escapeHtml(u.username)}')">${t('add_friend')}</button></div>`
            ).join('');
        }
    } catch (err) {
...
async function updateCoins() {
    try {
        const res = await safeFetch('/api/auto-login', { headers: authHeaders() });
        const data = await res.json();
        if (data.success) {
...
async function loadGameConfig() {
    try {
        const res = await safeFetch('/api/game/config', { headers: authHeaders() });
        const data = await res.json();
        if (data.success) {
            gameConfig = data;
...
async function playGame(game, choice) {
    ...
    if (!bet || bet < gameConfig.minBet) {
        return alert(`${t('min_bet')} ${gameConfig.minBet} ${t('coins')}`);
    }
    if (bet > gameConfig.maxBet) {
        return alert(`${t('max_label')} ${gameConfig.maxBet.toLocaleString()} ${t('coins')}`);
    }
    if (!currentUser || currentUser.coins < bet) {
        return alert(t('insufficient_coins'));
    }
    ...
    try {
        const res = await safeFetch('/api/game/play', {
            method: 'POST',
            headers: authHeaders(),
        ...
        if (!data.success) {
            resultEl.innerHTML = `<div class="game-lose">❌ ${escapeHtml(data.error)}</div>`;
...
async function showAdminGameLogs() {
    try {
        const res = await safeFetch('/api/game/admin-logs', { headers: authHeaders() });
...
function closeGameLogsModal() {
    document.getElementById('gameLogsModal').classList.remove('active');
}
...
async function checkVIPStatus() {
    if (!currentUser) return;
    try {
        const res = await safeFetch('/api/get-vip-status', { headers: authHeaders() });
        const data = await res.json();
...
async function buyVIP() {
    try {
        const res = await safeFetch('/api/buy-vip', {
            method: 'POST',
            headers: authHeaders()
        });
        const data = await res.json();
    ...
    try {
        ...
        if (data.success) {
            ...
            for (const member of data.members) {
                ...
                if (isOwner) {
                    nameColor = 'style="color:#ef4444; font-weight:bold;"';
                    roleBadge = ' 👑';
                } else if (isMod) {
                    nameColor = 'style="color:#f97316; font-weight:bold;"';
                    roleBadge = ' <span class="moderator-badge">MOD</span>';
                }

                const showKick = (currentUser.username === currentRoomOwner ||
                    currentRoomModerators.includes(currentUser.username)) &&
            ...
            if ((currentUser.username === currentRoomOwner ||
                currentRoomModerators.includes(currentUser.username)) &&
                data.kicked && data.kicked.length) {
                kickedCont.innerHTML = `<h4>${t('banned_users')}</h4>` +
                    data.kicked.map(k => `<div class="user-item"><span>${escapeHtml(k)}</span><button class="unban-btn" onclick="unbanUserFromRoom('${escapeHtml(k)}')">${t('unban')}</button></div>`).join('');
            } else {
                kickedCont.innerHTML = '';
            }
        }
    } catch (err) {
        console.error('loadRoomMembers error', err);
    }
}
...
async function loadMemberProfiles(members) {
    await Promise.all(members.map(async (m) => {
        ...
        try {
            const res = await safeFetch(
                `/api/user-profile?username=${encodeURIComponent(m)}`,
                { headers: authHeaders() }
            );
            const data = await res.json();
            if (data.success) {
                ...
                setTimeout(() => {
                    ...
                    const target = Array.from(items).find(el =>
                        el.getAttribute('onclick')?.includes(`'${m}'`)
                    );
...
async function kickUserFromRoom(username) {
    ...
    try {
        const res = await safeFetch('/api/kick-user', {
            method: 'POST',
            headers: authHeaders(),
            body: JSON.stringify({ roomName: currentRoom, username })
        });
        const data = await res.json();
        if (data.success) {
            alert('Kicked');
...
async function unbanUserFromRoom(username) {
    try {
        const res = await safeFetch('/api/unban-user', {
            method: 'POST',
            headers: authHeaders(),
            body: JSON.stringify({ roomName: currentRoom, username })
        });
...
async function showRoomSettings() {
    if (!currentRoom) return;
    const isOwnerOrMod = currentUser.username === currentRoomOwner ||
        currentRoomModerators.includes(currentUser.username);
    if (!isOwnerOrMod) return alert('Only owner or moderators can access settings');

    try {
        const res = await safeFetch(
            `/api/room-settings/${encodeURIComponent(currentRoom)}`,
            { headers: authHeaders() }
        );
        const data = await res.json();
        if (data.success) {
...
function renderMemberManageList(allowed, moderators, isOwner) {
    ...
    if (!cont) return;
    if (!allowed.length) {
        cont.innerHTML = '<div style="padding:10px;text-align:center;">No members added yet.</div>';
        return;
    }
...
async function toggleMembersOnly() {
    ...
    try {
        const res = await safeFetch('/api/room-settings', {
            method: 'POST',
            headers: authHeaders(),
            body: JSON.stringify({ roomName: currentRoom, membersOnly: mo })
        });
        const data = await res.json();
        if (data.success) {
            currentRoomMembersOnly = mo;
            alert(`Room is now ${mo ? 'Members Only' : 'Open'}`);
        } else {
            alert(data.error);
            document.getElementById('membersOnlyToggle').checked = !mo;
        }
    } catch (err) {
        alert('Network error');
    }
...
function addRoomMember() {
    ...
    if (!username) return;
    socket.emit('add-room-member', { roomName: currentRoom, username });
    document.getElementById('addMemberUsername').value = '';
}
function removeRoomMember(username) {
    if (!confirm(`Remove ${username}?`)) return;
    socket.emit('remove-room-member', { roomName: currentRoom, username });
}
function setModerator(username) {
    socket.emit('set-moderator', { roomName: currentRoom, username });
}
function removeModerator(username) {
    socket.emit('remove-moderator', { roomName: currentRoom, username });
}
function closeRoomSettingsModal() {
    document.getElementById('roomSettingsModal').classList.remove('active');
}
...
function createPeerConnection(config) {
    ...
    pc.onconnectionstatechange = () => {
        if (pc.connectionState === 'failed') {
            ...
            setTimeout(() => {
                if (callActive && currentPrivateChat) restartCall();
            }, 2000);
        }
    };
    return pc;
...
async function startCall() {
    ...
    if (!throttleCall('call')) { showToast(t('too_fast')); return; }
...
async function toggleSpeaker() {
    ...
    try {
        ...
        if (audioOutputs.length < 2) {
            showToast('Only one audio output');
            return;
        }
        let targetSinkId;
        if (!speakerEnabled) {
            const speakerDevice = audioOutputs.find(d =>
                /speaker|headphone/i.test(d.label)
            );
...
async function showUserProfile(username) {
    ...
    const isOnline = onlineUsers.some(u =>
        normalizeUsername(u) === normalizeUsername(username)
    );
    let avatarHtml = '👤';
    if (user.profile_pic) {
        if (typeof user.profile_pic === 'string' &&
...
async function showAllUsers() {
    try {
        const res = await safeFetch('/api/admin/get-all-users', { headers: authHeaders() });
        const users = await res.json();
        if (users.error) { alert('Admin access required'); return; }
        const html = users.map(u =>
            `<div>${escapeHtml(u.username)} (💰 ${u.coins}) ${u.isAdmin ? '👑' : ''} ${u.privateCode ? `🔑 <code style="font-size:11px;">${escapeHtml(u.privateCode)}</code>` : ''} <button onclick="deleteUser('${escapeHtml(u.username)}')">${t('delete')}</button></div>`
        ).join('');
...
async function deleteUser(username) {
    if (confirm('Delete user?')) {
        await safeFetch('/api/delete-user', {
            method: 'POST',
            headers: authHeaders(),
            body: JSON.stringify({ username })
        });
...
async function showAllRooms() {
    try {
        const res = await safeFetch('/api/get-all-rooms', { headers: authHeaders() });
        const rooms = await res.json();
        const html = rooms.map(r =>
            `<div>${escapeHtml(r.name)} (Owner: ${escapeHtml(r.owner)}) <button onclick="deleteRoom('${escapeHtml(r.name)}')">${t('delete')}</button></div>`
        ).join('');
...
async function deleteRoom(roomName) {
    if (confirm('Delete room?')) {
        await safeFetch('/api/delete-room', {
            method: 'DELETE',
            headers: authHeaders(),
...
async function showAllGifts() {
    try {
        ...
        const html = gifts.map(g =>
            `<div>${escapeHtml(g.from)} → ${escapeHtml(g.to)}: ${g.amount} coins (${new Date(g.timestamp).toLocaleString()})</div>`
        ).join('');
...
async function clearAllFriendRequests() {
    if (confirm('Clear all friend requests?')) {
        await safeFetch('/api/clear-friend-requests', {
            method: 'POST',
            headers: authHeaders()
        });
        alert('Cleared');
...
async function clearAllCoinRequests() {
    if (confirm('Clear coin history?')) {
        await safeFetch('/api/clear-coin-requests', {
            method: 'POST',
            headers: authHeaders()
        });
        alert('Cleared');
...
async function showBoostLogModal() {
    try {
        const res = await safeFetch('/api/get-boost-logs', { headers: authHeaders() });
        const logs = await res.json();
        const html = logs.map(l =>
            `<div>${escapeHtml(l.username)} boosted ${escapeHtml(l.roomName)} with ${l.amount} coins</div>`
        ).join('');
...
async function showPendingManualRequests() {
    try {
        const res = await safeFetch('/api/get-pending-manual-requests', { headers: authHeaders() });
        const reqs = await res.json();
        const html = reqs.map(r =>
            `<div>${escapeHtml(r.username)} requested ${r.amount} coins (${escapeHtml(r.paymentMethod)}) <button onclick="approveRequest('${r._id}')">${t('approve')}</button> <button onclick="rejectRequest('${r._id}')">${t('reject')}</button> ${r.proof ? `<a href="${escapeHtml(r.proof)}" target="_blank">Proof</a>` : ''}</div>`
        ).join('');
...
async function approveRequest(id) {
    await safeFetch('/api/approve-manual-request', {
        method: 'POST',
        headers: authHeaders(),
...
async function rejectRequest(id) {
    await safeFetch('/api/reject-manual-request', {
        method: 'POST',
        headers: authHeaders(),
        body: JSON.stringify({ requestId: id })
    });
...
async function adminGiveCoins() {
    ...
    await safeFetch('/api/admin-give-coins', {
        method: 'POST',
        headers: authHeaders(),
...
async function adminResetPassword() {
    ...
    await safeFetch('/api/admin-reset-password', {
        method: 'POST',
        headers: authHeaders(),
...
async function submitSupportTicket() {
    ...
    if (!subject || !message) {
        alert(t('fill_required') || 'Fill all fields');
        return;
    }
    ...
    try {
        const res = await safeFetch('/api/support/submit', {
            method: 'POST',
            headers: {
                'Authorization': `Bearer ${localStorage.getItem('chat_token')}`
            },
        ...
        if (data.success) {
            ...
            responseDiv.innerHTML = `<span style="color:red;">❌ ${escapeHtml(data.error)}</span>`;
        }
    } catch (err) {
...
async function showAdminSupportPanel() {
    ...
    try {
        const res = await safeFetch('/api/support/tickets?status=all', {
            headers: authHeaders()
        });
        const data = await res.json();
...
function closeAdminSupportModal() {
    document.getElementById('adminSupportModal').classList.remove('active');
}

async function clearAllSupportTickets() {
    if (!confirm('Clear ALL tickets?')) return;
    try {
        const res = await safeFetch('/api/support/clear-all', {
            method: 'POST',
            headers: authHeaders()
        });
        const data = await res.json();
...
async function sendSupportReply() {
    ...
    try {
        const res = await safeFetch('/api/support/reply', {
            method: 'POST',
            headers: authHeaders(),
            body: JSON.stringify({ ticketId: currentReplyTicketId, reply })
        });
        const data = await res.json();
        if (data.success) {
            alert('Sent');
...
async function resolveTicket(ticketId) {
    ...
    try {
        const res = await safeFetch('/api/support/resolve', {
            method: 'POST',
            headers: authHeaders(),
...
function openViewTicketModal(ticketId, reply) {
    ...
    document.getElementById('viewTicketReply').innerHTML =
...
function toggleRoomMenu(event) {
    ...
    if (isOpen) closeRoomMenu();
        ...
        setTimeout(() =>
            document.addEventListener('click', closeRoomMenuOnClickOutside), 0);
    }
}
...
function updateRoomMenuPermissions() {
    const isOwner = currentUser && currentRoom &&
        currentUser.username === currentRoomOwner;
    const isMod = currentUser && currentRoom && currentRoomModerators &&
        currentRoomModerators.includes(currentUser.username);
...
function onRoomTyping() {
    if (currentRoom && socket) {
        if (window._isComposingRoom) return;
...
function onPrivateTyping() {
    if (currentPrivateChat && socket) {
        if (window._isComposingPrivate) return;
        socket.emit('private-typing', { to: currentPrivateChat });
        clearTimeout(typingTimeoutPrivate);
        typingTimeoutPrivate = setTimeout(() => {
            socket.emit('private-stop-typing', { to: currentPrivateChat });
        }, 1000);
    }
}
...
// ============================================================
function setupIMECompositionTracking() {
    const inputs = [
        { id: 'loginUsername', flag: '_isComposingLoginU' },
        { id: 'loginPassword', flag: '_isComposingLoginP' },
        { id: 'regUsername', flag: '_isComposingRegU' },
        { id: 'regPassword', flag: '_isComposingRegP' },
        { id: 'regSecurityQuestion', flag: '_isComposingRegQ' },
        { id: 'regSecurityAnswer', flag: '_isComposingRegA' },
        { id: 'resetUsername', flag: '_isComposingResetU' },
        { id: 'resetAnswer', flag: '_isComposingResetA' },
        { id: 'newPassword', flag: '_isComposingResetP' },
        { id: 'roomMessageInput', flag: '_isComposingRoom' },
        { id: 'privateMessageInput', flag: '_isComposingPrivate' },
        { id: 'youtubeSearchInput', flag: '_isComposingYT' },
        { id: 'roomSearch', flag: '_isComposingRoomSearch' },
        { id: 'friendSearch', flag: '_isComposingFriendSearch' },
        { id: 'supportSubject', flag: '_isComposingSupS' },
        { id: 'supportMessage', flag: '_isComposingSupM' },
        { id: 'replyMessage', flag: '_isComposingReply' },
        { id: 'newRoomName', flag: '_isComposingRoomName' },
        { id: 'roomGiftMessage', flag: '_isComposingGiftMsg' },
        { id: 'addMemberUsername', flag: '_isComposingAddMem' },
        { id: 'banUsername', flag: '_isComposingBan' }
    ];

    inputs.forEach(({ id, flag }) => {
        const el = document.getElementById(id);
        if (!el || el._imeSetup) return;
        el._imeSetup = true;

        el.addEventListener('compositionstart', () => { window[flag] = true; });
        el.addEventListener('compositionend', () => {
            window[flag] = false;
            autoAdjustDirection(el);
        });
...
function autoAdjustDirection(el) {
    if (!el || !el.value) return;
    const firstChar = el.value.trim().charAt(0);
    if (!firstChar) return;
...
// ============================================================
// ⭐⭐⭐ SOCKET INITIALIZATION (محمي بالمصادقة)
// ============================================================
function initSocket() {
    ...
    socket.on('connect', () => {
        ...
        if (lastRoom && !currentRoom) {
            setTimeout(() => socket.emit('join-room', lastRoom), 300);
        }
    });

    // ⭐⭐⭐ Connect Error (توكن منتهي/رفض)
    ...
    socket.on('rate-limited', (data) => {
        console.warn('⚠️ Rate limited:', data.event);
        rateLimitCount++;
        if (data.retryAfter) {
            showToast(`⏳ ${t('rate_limited')} (${data.retryAfter}s)`);
        } else {
            showToast(t('rate_limited'));
        }
        if (rateLimitCount >= 10) {
            alert('⚠️ You are sending too many requests. Logging out.');
            logout();
        }
        setTimeout(() => rateLimitCount = Math.max(0, rateLimitCount - 1), 60000);
    });

    // ⭐⭐⭐ Warning (نشاط مشبوه)
    socket.on('warning', (msg) => {
        console.warn('⚠️ Server warning:', msg);
        warningCount++;
        showToast(t('suspicious'));
        if (warningCount >= 3) {
            alert('⚠️ Your account has been flagged. Logging out.');
            logout();
        }
    });
    ...
    socket.on('room-joined', (data) => {
        ...
        document.getElementById('roomChatName').innerHTML =
            `#${escapeHtml(data.room)}${data.isVipRoom ? ' 💎' : ''}`;
        document.getElementById('roomChatStats').innerHTML =
            `${data.members.length} ${t('members')} | ${t('boost')}: ${data.boostLevel || 0}`;
        ...
        const msgCont = document.getElementById('roomMessages');
        const header = document.getElementById('roomChatHeader');

        if (data.isVipRoom) {
            chatCont.classList.add('vip-room-chat');
            ...
            document.getElementById('roomChatStats').classList.add('vip-room-stats');
        } else {
            chatCont.classList.remove('vip-room-chat');
    ...
    socket.on('user-joined-room', (data) => {
        addSystemMessage(`${data.username} ${t('joined')}`, 'roomMessages');
        loadRoomMembers();
    });
    socket.on('user-left-room', (data) => {
        addSystemMessage(`${data.username} ${t('left')}`, 'roomMessages');
        loadRoomMembers();
    });
    socket.on('room-boosted', (data) => {
        addSystemMessage(
            `🚀 ${data.boostedBy} ${t('boosted')} ${data.amount} ${t('coins')}! ${t('total_boost')}: ${data.boostLevel}`,
            'roomMessages'
        );
        document.getElementById('roomChatStats').innerHTML =
            `${t('boost')}: ${data.boostLevel}`;
        socket.emit('get-room-list');
    });
    socket.on('new-private-message', (msg) => {
        playNotificationSound();
        if (currentPrivateChat === msg.from) {
            addPrivateMessage(msg);
        } else {
            addNotification(
                t('new_message'),
                `${msg.from}: ${msg.message.substring(0, 50)}`,
                { type: 'private_message', from: msg.from }
            );
        }
    });
    ...
    socket.on('gift-received', (gift) => {
        ...
        updateCoins();
        loadGiftHistory();
        addNotification(t('gift_received'),
            `${gift.from} ${t('sent_gift')} ${gift.amount} ${t('coins')}!`);
    ...
    socket.on('streak-status', (data) => {
        if (currentUser) {
            currentUser.consecutiveLoginDays = data.consecutiveLoginDays;
        }
    });
    ...
    socket.on('target-not-reached', (data) => {
        playNotificationSound();
        addNotification('⚠️ Target Not Reached',
            `Target: ${data.currentTarget.toLocaleString()}/${data.minTarget.toLocaleString()}`);
        loadTargetInfo();
    });
    ...
    socket.on('support-reply', (data) => {
        ...
        addNotification(
            t('support_reply'),
            `Admin ${t('replied_ticket')} ${data.ticketId}`,
            { type: 'support_ticket', ticketId: data.ticketId, reply: data.reply }
        );
        showToast(`📬 ${t('new_reply_support')} ${data.ticketId}`);
    });
    socket.on('support-resolved', (data) => {
        playNotificationSound();
        addNotification(t('ticket_resolved'),
            `${t('your_ticket')} ${data.ticketId} ${t('resolved')}.`);
    });
    socket.on('new-support-ticket', (data) => {
        if (currentUser.isAdmin) {
            addNotification(t('new_support_ticket'), `${data.username}: ${data.subject}`);
        }
    });
    ...
    socket.on('friend-request-sent', (data) =>
        showToast(`${t('friend_request_sent_to')} ${data.to}`));
    ...
    socket.on('boost-reset', (data) => {
        ...
        if (currentRoom) {
            ...
            if (boostElement) {
                boostElement.innerHTML = boostElement.innerHTML.replace(
                    /Boost: \d+/, `${t('boost')}: 0`
                );
            }
        }
    ...
    socket.on('user-typing', (data) => {
        if (currentRoom === data.room) {
            document.getElementById('roomTypingIndicator').textContent =
    ...
    socket.on('private-user-typing', (data) => {
        if (currentPrivateChat === data.from) {
            document.getElementById('privateTypingIndicator').textContent =
                `${data.from} is typing...`;
        }
    });
...
function showManualCoinRequestModal() {
    document.getElementById('manualCoinRequestModal').classList.add('active');
}
function closeManualCoinRequestModal() {
    document.getElementById('manualCoinRequestModal').classList.remove('active');
}
...
async function showCoinHistoryModal() {
    ...
    try {
        const res = await safeFetch('/api/get-coin-history', { headers: authHeaders() });
...
function closeCoinHistoryModal() {
    document.getElementById('coinHistoryModal').classList.remove('active');
}

function toggleManualPaymentFields() {
    const method = document.getElementById('manualPaymentMethod').value;
    document.getElementById('giftCardFields').style.display =
        method === 'giftcard' ? 'block' : 'none';
...
async function sendManualCoinRequest() {
    ...
    if (!amount || amount < 100) {
        return alert(t('amount_min_100') || 'Amount min 100');
    }
    ...
    try {
        const res = await safeFetch('/api/manual-coin-request', {
            method: 'POST',
            headers: {
                'Authorization': `Bearer ${localStorage.getItem('chat_token')}`
            },
        ...
        const data = await res.json();
        if (data.success) {
            alert(t('request_submitted') || 'Submitted!');
        } else {
...
async function purchaseCoins(coins, name, price, method) {
    ...
    if (method === 'nowpayment') {
        await startCryptoPayment(coins);
    } else {
        alert('⚠️ Use Crypto or Manual Request');
    }
}
...
async function startCryptoPayment(packageId) {
    try {
        ...
        const res = await safeFetch('/api/nowpayments/create-invoice', {
            method: 'POST',
            headers: authHeaders(),
            body: JSON.stringify({ packageId: String(packageId) })
        });
        const data = await res.json();
        if (!data.success) {
...
function pollCryptoPayment(orderId, fromReturn = false) {
    ...
    const tick = async () => {
        attempts++;
        try {
            const res = await safeFetch(`/api/nowpayments/status/${orderId}`, {
                headers: authHeaders()
            });
            const data = await res.json();
            if (!data.success) return;
            if (data.credited || data.status === 'finished' ||
...
function handlePaymentReturn() {
    ...
    if (payment === 'success' && order) {
        ...
        showToast(t('payment_cancelled') || 'Cancelled');
    }
}
...
if (langSwitcher) {
    ...
    langSwitcher.addEventListener('change', (e) => {
        ...
        if (activeEl && (activeEl.tagName === 'INPUT' ||
            ...
            if (!confirm('تغيير اللغة؟ سيتم الاحتفاظ بما كتبته.\nChange language? Your input will be kept.')) {
...
setupIMECompositionTracking();

autoLogin();
handlePaymentReturn();
console.log('⚡ Chat app loaded (SECURE v2.0 + Anti-Impersonation + Anti-Flood)');
