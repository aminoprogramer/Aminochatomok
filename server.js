...
// ⭐ UPDATED: Resolve now DELETES the ticket and notifies user
app.post('/api/support/resolve', async (req, res) => {
    try {
        ...
        // Delete the ticket instead of marking as resolved
...
// ⭐ NEW: Clear all support tickets and notify users
app.post('/api/support/clear-all', async (req, res) => {
    try {
        ...
        // Get all tickets to notify users before deleting
        const tickets = await SupportTicket.find({});

        // Notify each user that their ticket was cleared
