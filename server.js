...
// ⭐ FIX: wrapped in try/catch, always returns JSON
...
// ⭐ FIX: was returning 403 with an empty body when admin check failed.
//         Now always returns JSON with an `error` field, and DB errors
//         are caught and returned as 500 JSON instead of an HTML error page.
...
// ⭐ FIX: wrapped in try/catch, returns proper JSON errors
